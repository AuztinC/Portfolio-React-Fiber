...
Command: npx gltfjsx@6.2.15 arc-scene2.gltf 
*/

import React, { useRef } from 'react'
import { useGLTF } from '@react-three/drei'

export default function ArcScene(props) {
  const { nodes, materials } = useGLTF('../assets/obj/arc-scene/arc-scene2.gltf')
  return (
    <group {...props} dispose={null}>
      <group position={[0, -0.25, 0]}>
        <mesh geometry={nodes.CUText.geometry} material={materials['Arc-Base']} castShadow/>
        <mesh geometry={nodes.CUText_1.geometry} material={materials['Arc-Emit']} castShadow material-toneMapped={false} material-emissiveIntensity={3}/>
      </group>
...
useGLTF.preload('../assets/obj/arc-scene/arc-scene2.gltf')
